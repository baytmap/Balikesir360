...
[![Actions Status](https://github.com/{weden-wendy}/{piexif}/workflows/{main.yml}/badge.svg)](https://github.com/{weden-wendy}/{piexif}/actions)

This repository is forked from [piexif-ts](https://github.com/holwech/piexif-ts) which is based off of [piexifjs](https://github.com/hMatoba/piexifjs).

Add Error ByPass and reset Orientation functionality to the Typescript version [piexif-ts](https://github.com/holwech/piexif-ts) of the original [piexifjs](https://github.com/hMatoba/piexifjs). See original documentation for how to use it.
